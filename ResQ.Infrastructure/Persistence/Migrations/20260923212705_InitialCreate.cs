...
namespace ResQ.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EmergencyId = table.Column<int>(type: "int", nullable: false),
                    ResponseTeamId = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Missions_Emergencies_EmergencyId",
                        column: x => x.EmergencyId,
                        principalTable: "Emergencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Missions_ResponseTeams_ResponseTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Emergencies_TrackingNumber",
                table: "Emergencies",
                column: "TrackingNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyHistories_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyTypes_Name",
                table: "EmergencyTypes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Missions_EmergencyId_ResponseTeamId",
                table: "Missions",
                columns: new[] { "EmergencyId", "ResponseTeamId" });

            migrationBuilder.CreateIndex(
                name: "IX_Missions_ResponseTeamId",
                table: "Missions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResponseTeams_Status",
                table: "ResponseTeams",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_ResponseTeams_TeamType",
                table: "ResponseTeams",
                column: "TeamType");
        }
